...
function select()
{
	...
	index5 = Math.floor(Math.random() * 9);
	index6 = Math.floor(Math.random() * 9);
	index7 = Math.floor(Math.random() * 9);
	index8 = Math.floor(Math.random() * 9);
	index9 = Math.floor(Math.random() * 9);
